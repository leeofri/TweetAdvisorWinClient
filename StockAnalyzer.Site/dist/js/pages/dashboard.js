...
<!-------------------------------------Trends Report--------------------------------------------------->
    ...
    function firstInitTrendsReport(startDate, endDate){        
        getCandidatesData(startDate, endDate, initMorrisFunc);
    };
    ...
    firstInitTrendsReport(getLastWeeksDate(), getTodayDate(), initMorrisFunc);
    ...
    $("#startDate").change(function(){
        ...
        firstInitTrendsReport($("#startDate").val(),$("#endDate").val());
    });
